...
VALUES 
    ('Javascript', 28, 71457, 12529489, 15, 15),
    ('Python', 32, 67500, 90232242, 20, 20),
    ('Go', 14,  65000, 9959490, 12, 12),
    ('Java', 27, 77091, 20340247, 17, 17),
    ('Kotlin', 13, 41810, 1042196, 4, 4),
    ('PHP', 29, 41830, 9475496, 14, 14),
    ('C#', 23, 52500, 22375966, 16, 16),
    ('Swift', 9, 60375, 135064, 9, 9),
    ('Assembly', 76, 51931, 606205, 13, 13),
    ('Ruby', 28, 70784, 3365134, 10, 10),
    ('C', 51, 46550, 25457435, 19, 19),
    ('COBOL', 64, 42842, 50825, 7, 7),
    ('Fortran', 66, 47499, 310454, 11, 11),
    ('Scala', 19, 47087, 688777, 2, 2),
    ('C++', 38, 79475, 23457435, 18, 18),
