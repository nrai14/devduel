...
def test_all(db_connection):
    ...
    assert repository.all() == [
        Card(1, 'Javascript', 28, 1, 71457, 1, 1),
        Card(2, 'Python', 32, 1, 67500, 1, 1),
        Card(3, 'Go', 14, 1, 65000, 1, 1),
        Card(4, 'Java', 27, 1, 77091, 1, 1),
        Card(5, 'Kotlin', 13, 1, 41810, 1, 1),
        Card(6, 'PHP', 29, 1, 41830, 1, 1),
        Card(7, 'C#', 23, 1, 52500, 1, 1),
        Card(8, 'Swift', 9, 1, 60375, 1, 1), 
        Card(9, 'Assembly', 76, 1, 51931, 1, 1),
        Card(10, 'Ruby', 28, 1, 70784, 1, 1),
